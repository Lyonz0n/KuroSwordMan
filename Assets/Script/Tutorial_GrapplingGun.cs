...
public class Tutorial_GrapplingGun : MonoBehaviour
{
    ...
    void SetGrapplePoint()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(firePoint.position, distanceVector.normalized, maxDistance);

        if (hit.collider != null && (hit.collider.gameObject.layer == grappableLayerNumber || grappleToAll))
        {
