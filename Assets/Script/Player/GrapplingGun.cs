...
public class GrapplingGun : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        fireAction.started += ctx => OnFireStarted();
        fireAction.performed += ctx => OnFirePerformed();
        fireAction.canceled += ctx => OnFireCanceled();
    }
    ...
    private void Update()
    {
        Mouse_FirePoint_DistanceVector = m_camera.ScreenToWorldPoint(Mouse.current.position.ReadValue()) - gunPivot.position;
    ...
    private void OnFirePerformed()
    {
        ...
        {
            RotateGun(m_camera.ScreenToWorldPoint(Mouse.current.position.ReadValue()), false);
        }
